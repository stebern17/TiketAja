...
<!-- Search -->
<div class="mt-3">
    <form class="d-flex align-items-center" style="height: 40px;">
        <div class="input-group flex-grow-1 me-2 border border-primary rounded-1">
            <input type="text" class="form-control" placeholder="Cari Event Disini..." aria-label="Cari Event">
            <select class="form-select" aria-label="Pilih Lokasi" style="max-width: 150px;">
...
<div class="mt-4 relative">
    ...
    <div class="grid grid-cols-5 gap-3 mt-3 d-flex flex-wrap">
    ...
    <!-- Banner -->
    <div class="container bg-warning p-3 rounded" style="height: 180px; margin-block: 100px; background-image: url({{ asset('assets/img/banner7.png') }}); background-size: cover; background-position: center; background-repeat: no-repeat;">
