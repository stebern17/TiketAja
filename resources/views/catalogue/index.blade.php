...
<div class="mt-3">
    <form class="grid grid-cols-6 gap-3 text-sm">
        ...
        <button class="bg-blue-800 text-white py-2 rounded-xl hover:opacity-80">
            Cari Event
        </button>
    </form>
</div>
...
<div class="flex mt-3 gap-2">
    <button class="py-2 px-2 bg-white rounded-md text-sm text-blue-800 font-semibold shadow-md hover:opacity-80">
        Konser
    </button>
    <button class="py-2 px-2 bg-white rounded-md text-sm text-blue-800 font-semibold shadow-md hover:opacity-80">
        Seminar & Workshop
...
<div class="mt-4 relative">
    ...
    <div class="grid grid-cols-5 gap-3 mt-3">
        <div class="bg-white shadow-lg p-3 rounded-md">
            ...
            <p class="text-xs text-slate-500 mb-2">Minggu, 8 Des 2024</p>
